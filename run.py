...
def update_sales_worksheet(data):
    """
    Update sales worksheet, add new row for user input data.
    """
    print("Adding data to sales worksheet...\n")
    sales_worksheet = SHEET.worksheet("sales")
    sales_worksheet.append_row(data)
    print("Sales worksheet sucessfully updated. \n")
...
def update_surplus_worksheet(data):
    ...
    """
    print("Adding data to surplus worksheet...\n")
    surplus_worksheet = SHEET.worksheet("surplus")
    surplus_worksheet.append_row(data)
    print("Surplus worksheet sucessfully updated.\n")
